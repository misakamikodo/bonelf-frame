...
import com.bonelf.auth.core.oauth2.service.MailUserDetailsService;
import com.bonelf.auth.core.oauth2.service.MobileUserDetailsService;
import com.bonelf.auth.core.oauth2.service.OpenIdUserDetailsService;
...
public class WebServerSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public MobileAuthenticationProvider mobileAuthenticationProvider() {
		...
		((MobileUserDetailsService)this.mobileUserDetailsService).setPasswordEncoder(passwordEncoder);
	...
	public MailAuthenticationProvider mailAuthenticationProvider() {
		PasswordEncoder passwordEncoder = passwordEncoder();
		((MailUserDetailsService)this.mailUserDetailsService).setPasswordEncoder(passwordEncoder);
		MailAuthenticationProvider mailAuthenticationProvider =
				new MailAuthenticationProvider(this.mailUserDetailsService);
	...
	public OpenIdAuthenticationProvider openIdAuthenticationProvider() {
		PasswordEncoder passwordEncoder = passwordEncoder();
		((OpenIdUserDetailsService)this.openidUserDetailsService).setPasswordEncoder(passwordEncoder);
		OpenIdAuthenticationProvider openIdAuthenticationProvider =
				new OpenIdAuthenticationProvider(this.openidUserDetailsService);
