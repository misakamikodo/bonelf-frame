...
public enum CommonBizExceptionEnum implements AbstractBaseExceptionEnum {
	...
	REQUEST_INVALIDATE_EMPTY("400", "%s不能为空"),
	...
	REQ_NOT_FEIGN("500", null,"this request must be feign");

	CommonBizExceptionEnum(String code, String message, String devMessage) {
		this.code = code;
		this.message = message;
		this.devMessage = devMessage;
	}

	CommonBizExceptionEnum(String code, String message) {
		this.code = code;
		this.message = message;
	}
