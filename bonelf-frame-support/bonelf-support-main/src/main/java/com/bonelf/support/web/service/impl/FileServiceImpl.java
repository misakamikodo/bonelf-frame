...
public class FileServiceImpl implements FileService {
	...
	public String uploadFile(MultipartFile file) {
		...
		return bonelfProperties.getBaseUrl() + typeDirName + "/" + dateDirName + "/" + validFileName;
	}
	...
	public String uploadOssFile(MultipartFile file) throws IOException {
		...
		OSSClient ossClient = new OSSClient(ossProperties.getEndpoint(), ossProperties.getAccessKeyId(), ossProperties.getAccessSecret());
